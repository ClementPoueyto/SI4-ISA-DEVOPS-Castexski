...
public class Server
{
   ...
   */
  public void start() {
    Console.WriteLine("Starting a the Weather Forecast Server... ");
    ...
    Host.AddServiceEndpoint(typeof(IWeatherService), b, "");
  ...
  public void configure(string[] args) {
    ...
    int weatherIndex = Array.FindLastIndex(args, key => key == "weather");
    if (weatherIndex != -1) { Weather = args[weatherIndex + 1]; }
  }
